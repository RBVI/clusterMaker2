...
public class BicFinder extends AbstractAttributeClusterer{

	public static String SHORTNAME = "BicFinder";
	public static String NAME = "BicFinder  bi-cluster";
	...
	@ContainsTunables
	public BicFinderContext context = null;
	
	public BicFinder(BicFinderContext context, ClusterManager clusterManager) {
