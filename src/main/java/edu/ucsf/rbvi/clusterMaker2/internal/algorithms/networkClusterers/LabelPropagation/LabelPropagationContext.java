package edu.ucsf.rbvi.clusterMaker2.internal.algorithms.networkClusterers.LabelPropagation;
	...
	public class LabelPropagationContext implements ClusterAlgorithmContext {
		...
		public LabelPropagationContext() {
			advancedAttributes = new AdvancedProperties("__labelPropagationCluster", false); //this is the name of the column Integer that is created when click LOAD
		}

		public LabelPropagationContext(LabelPropagationContext origin) {
