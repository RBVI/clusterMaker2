...
public class ResultPanelPCoA extends JPanel{
	...
	private ResultPanelPCoA.PCBrowserPanel pcBrowserPanel;
	private List<Integer> nodeCount = new ArrayList<Integer>();
	private static double[] varianceArray;

	private static JFrame frame;

	public ResultPanelPCoA(final CyMatrix[] components, 
	...
	private class PCBrowserPanel extends JPanel implements ListSelectionListener {
		private final ResultPanelPCoA.PCBrowserTableModel browserModel;
		...
		public PCBrowserPanel() {
			...
			// main data table
			browserModel = new ResultPanelPCoA.PCBrowserTableModel();
	...
	public static void createAndShowGui(final CyMatrix[] components, 
		...
		ResultPanelPCoA.varianceArray = varianceArray;
		ResultPanelPCoA resultPanelPCA = new ResultPanelPCoA(components, network, networkView);
