package edu.ucsf.rbvi.clusterMaker2.internal.algorithms.networkClusterers.Multilevel;
	...
	public class MultilevelContext implements ClusterAlgorithmContext {
		...
		public MultilevelContext() {
			advancedAttributes = new AdvancedProperties("__multilevelCluster", false); //this is the name of the column Integer that is created when click LOAD
		}

		public MultilevelContext(MultilevelContext origin) {
